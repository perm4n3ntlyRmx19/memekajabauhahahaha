...
def info():
	...
	print (Y+"\n 0{======================"+W+" INFO "+Y+"=======================}0")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Name     "+C+":"+W+" s4ktiaje"+Y+"                               |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Code     "+C+":"+W+" python"+Y+"                               |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Version  "+C+":"+W+" 3.0.1 (alpha)"+Y+"                        |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Author   "+C+":"+W+" Mr.Rm19 "+R+"a.k.a "+W+"ramdan ganteng"+Y+"                 |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Email    "+C+":"+W+" ramdan19id@gmail.com"+Y+"                   |")
	print (Y+" 0{===================================================}0\n")
